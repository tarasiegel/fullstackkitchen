    ...
    ingredients: [
        {
            ...
            data: [
                {
                    ...
                    text: "1.5 cup Granulated Sugar",
                    reference: "granulated"
                },{
                    text: "0.5 cup Water",
                    reference: "water"
                },{
            ...
            data: [
                {
                  text: "160g (1 stick + 4 Tbps) Butter, cut into cubes",
                  reference: "butter"
                },{
                  text: "160g Chopped dark chocolate",
                  reference: "chocolate"
                },{
                  text: "3 Eggs",
                  reference: "eggs"
                  ...
                  text: "90g Cake Flour (or APF)",
                  reference: "flour"
                },{
                  text: "20g Cocoa Powder",
                  reference: "cocoa"
                },{
                  text: "150g Halva, cut into 1/2in cubes (about 1/2 of the recipe above or store bought)",
                  reference: "halva"
                },{
                  text: "1 cup Raspberries",
                  reference: "raspberries"
                },{
                  text: "2-3 Tbsp Tahini, or more for drizzling",
                  reference: "some tahini"
                }
            ]
        }
    ],
