      ...
      <Layout location={this.props.location} title={siteTitle}>
        ...
        <div className="blog-post--left">
          ...
          <div className="recipe-tags">
            {post.frontmatter.tags.map((tag, key) => (
              <a
                ...
                href={`/recipes#recipe-index-section-${tag}`}
                key={key}
              >{`  ${tag}  `}</a>
            ))}
          </div>
          ...
          <div className="blog-post__bottom">
            <div className="blog-post__bottom-title">
              follow at{' '}
              <a href="https://www.instagram.com/taras.kitchen" target="_blank" rel="noreferrer">
                @taras.kitchen
              </a>
            </div>
