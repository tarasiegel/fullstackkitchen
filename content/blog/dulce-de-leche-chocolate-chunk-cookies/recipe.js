    ...
    ingredients: [
      {
        ...
        data: [
          ...
          {
            text: '2 sticks (227g) butter',
            reference: 'butter'
          },
          {
            text: '3/4 cup (150g) brown sugar',
          ...
          {
            text: '130g dark chocolate, chopped roughly',
            reference: 'dark chocolate'
          },
          {
            text: '70g milk chocolate, chopped roughly',
            reference: 'milk chocolate'
          },
          {
            text: '90g dulce de leche',
            reference: 'dulce de leche'
          }
        ]
      }
    ],
