    ...
    ingredients: [
      {
        ...
        data: [
          ...
          {
            text: '5 Tbsp (70g) butter, melted',
            reference: 'melted'
          },
          {
            text: '3 Tbsp (38g) sugar',
            reference: 'sugar'
          },
          {
            text: 'pinch of salt',
      ...
      },
      {
        ...
        data: [
          {
            text: '6 oz dark chocolate, chopped',
            reference: 'dark chocolate'
          },
          {
            text: '2.5 Tbsp (35g) butter',
            reference: 'butter'
          },
          {
        ...
        data: [
          {
            ...
            reference: 'pudding mix'
          },
          {
            text: '4 oz cool whip (half of a container, thawed)',
            reference: 'cool whip'
          },
          {
            text: '1 1/4 cup whole or 2% milk',
            reference: 'milk'
          },
          {
            text: '6-8 oreos, crushed',
            reference: 'crushed Oreos'
          }
        ]
      }
    ],
